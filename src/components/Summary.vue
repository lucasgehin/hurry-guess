<template>
  <div>
    ...
    <div class="action-middle">
      <router-link to="/play" class="button button--big">Jouer</router-link>
    </div>

    <div class="action-bottom">
      <router-link to="/settings" class="button button--ghost">
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 268.765 268.765" style="enable-background:new 0 0 268.765 268.765;" xml:space="preserve" width="30px" height="30px">
          <g id="Settings">
            <g>
              <path fill="#000" style="fill-rule:evenodd;clip-rule:evenodd;" d="M267.92,119.461c-0.425-3.778-4.83-6.617-8.639-6.617
      ...
      <router-link to="/demo" class="button button--ghost">
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         width="30px" height="30px" viewBox="0 0 31.357 31.357" style="enable-background:new 0 0 31.357 31.357;"
         xml:space="preserve">
          <g>
